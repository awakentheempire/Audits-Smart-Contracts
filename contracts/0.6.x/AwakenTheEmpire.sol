...
// Awaken The Empire with Governance.
contract AwakenTheEmpireToken is BEP20('Awaken The Empire Token', 'ATE'), LGEWhitelisted {
    uint256 private _cap = 2500000000e18;
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "ATE::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "ATE::delegateBySig: invalid nonce");
        require(now <= expiry, "ATE::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "ATE::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying ATEs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "ATE::_writeCheckpoint: block number exceeds 32 bits");
